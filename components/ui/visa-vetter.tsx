...
export default function VisaVetter() {
    ...
    const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (selectedCategory && selectedCategoryData?.acceptedTypes &&
            !selectedCategoryData.acceptedTypes.includes(fileType)) {
            setError(`Invalid file type. Accepted types: ${selectedCategoryData.acceptedTypes}`)
            return
        }
    ...
    const handleCategoryChange = (value: string) => {
        ...
        if (selectedFile) {
            ...
            if (category?.acceptedTypes && !category.acceptedTypes.includes(fileType)) {
